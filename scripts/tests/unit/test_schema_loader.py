...
class TestSchemaLoader(unittest.TestCase):
    ...
    def test_eval_globs(self, mock_warn):
        ...
        self.assertTrue(
            mock_warn.called, "a warning should have been printed for missing*"
        )
        self.assertIn("schemas/base.yml", files)
        self.assertEqual(
            list(filter(lambda f: f.startswith("missing"), files)),
            [],
    ...
    def test_eval_globs_pattern(self, mock_warn):
        ...
        self.assertEqual(
            ["schemas/agent.yml", "schemas/as.yml"].sort(),
            files.sort(),
    ...
    def test_eval_globs_filenames(self, mock_warn):
        ...
        self.assertEqual(
            ["schemas/agent.yml", "schemas/x509.yml"],
            files,
    ...
    def test_eval_globs_folders(self, mock_warn):
        ...
        self.assertIn(
            "usage-example/fields/custom/acme.yml",
            files,
    ...
    def schema_base(self):
        return {
            "base": {
                ...
                "fields": {
                    "message": {"field_details": {"name": "message", "type": "keyword"}}
                },
            }
        }
    ...
    def schema_process(self):
        return {
            "process": {
                "schema_details": {},
                "field_details": {"name": "process", "type": "group"},
                "fields": {
                    "pid": {"field_details": {"name": "pid", "type": "keyword"}},
                    "parent": {
    ...
    def test_load_schemas_fail_on_accidental_fieldset_redefinition(
        self, mock_read_schema
    ):
        mock_read_schema.side_effect = [
            {"file": {"name": "file", "type": "keyword"}},
    ...
    def test_load_schemas_allows_unique_fieldsets(self, mock_read_schema):
        file_map = {"file": {"name": "file", "type": "keyword"}}
        host_map = {"host": {"name": "host", "type": "text"}}
        mock_read_schema.side_effect = [file_map, host_map]
        exp = {"file": file_map["file"], "host": host_map["host"]}
    ...
    def test_nest_schema_raises_on_missing_schema_name(self):
        with self.assertRaisesRegex(ValueError, "incomplete.yml"):
            loader.nest_schema(
                [{"description": "just a description"}], "incomplete.yml"
            )
    ...
    def test_deep_nesting_representation(self):
        all_schemas = {
            "base": {
                ...
                "root": True,
                "type": "group",
                "fields": [{"name": "message", "type": "keyword"}],
            },
            "process": {
                "name": "process",
                "type": "group",
        ...
        self.assertEqual(
            process_fields["parent"]["field_details"]["intermediate"], True
        )
    ...
    def test_merge_new_schema(self):
        custom = {
            "custom": {
                "schema_details": {},
                "field_details": {"name": "custom", "type": "group"},
                "fields": {
                    "my_field": {
                        "field_details": {"name": "my_field", "type": "keyword"}
                    }
                },
            }
        }
    ...
    def test_merge_field_within_schema(self):
        ...
        expected_fields = {
            "base": {
                ...
                "fields": {
                    "message": {
                        "field_details": {"name": "message", "type": "keyword"}
                    },
                    "my_field": {
                        "field_details": {"name": "my_field", "type": "keyword"}
                    },
        ...
        merged_fields = loader.merge_fields(self.schema_base(), custom)
        self.assertEqual(
            ["message", "my_field"], sorted(expected_fields["base"]["fields"].keys())
        )
        self.assertEqual(
            expected_fields,
            merged_fields,
    ...
    def test_merge_array_attributes(self):
        ...
        ecs = {
            "foo": {
                "schema_details": {
                    "reusable": {"top_level": True, "expected": ["normal.location"]}
                },
        ...
        custom = {
            "foo": {
                "schema_details": {"reusable": {"expected": ["a_new.location"]}},
                "field_details": {"name": "foo", "type": "group"},
                "fields": {
                    "normalized_field": {
                        "field_details": {
        ...
        self.assertEqual(
            merged_fields["foo"]["fields"]["normalized_field"]["field_details"][
                "normalize"
            ],
            ["lowercase", "array"],
        )
        self.assertEqual(
            merged_fields["foo"]["fields"]["not_initially_normalized"]["field_details"][
                "normalize"
            ],
            ["array"],
        )
    ...
    def test_merge_non_array_attributes(self):
        ...
        expected_fields = {
            "base": {
                "schema_details": {"root": False, "group": 3},
                "field_details": {"name": "base", "type": "object", "example": "foo"},
                "fields": {
                    "message": {
                        "field_details": {
                            "name": "message",
    ...
    def test_merge_and_overwrite_multi_fields(self):
        originalSchema = {
            "overwrite_field": {
                "field_details": {
                    "multi_fields": [{"type": "text", "name": "text", "norms": True}]
                },
                "fields": {
                    "message": {
                        "field_details": {
                            "multi_fields": [{"type": "text", "name": "text"}]
                        }
                    }
                },
            }
        ...
        expected_overwrite_field_mf = [{"type": "text", "name": "text"}]
        ...
        self.assertEqual(
            merged_fields["overwrite_field"]["field_details"]["multi_fields"],
            expected_overwrite_field_mf,
        )
        self.assertEqual(
            merged_fields["overwrite_field"]["fields"]["message"]["field_details"][
                "multi_fields"
            ],
            expected_message_mf,
        )
